...
void creditos(){
  ...
  gtk_about_dialog_set_license (GTK_ABOUT_DIALOG (dialog), "Para uso libre");
  gtk_about_dialog_set_website (GTK_ABOUT_DIALOG (dialog),"https://github.com/CesarArellano/Sistema-Integral-de-Informacion-Clinica");
  gtk_about_dialog_set_website_label (GTK_ABOUT_DIALOG (dialog),"https://github.com/CesarArellano/Sistema-Integral-de-Informacion-Clinica");
